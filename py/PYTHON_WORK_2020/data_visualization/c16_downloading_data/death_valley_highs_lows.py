...
temperatures for Death Valley, CA in 2018. It uses data from the NOAA's 
...
with open(filename) as f:
    ...
    # Finds the columns that contain the dates, and high and low temperatures.
    ...
    # Store the dates, and high and low temperatures.
    dates, highs, lows = [], [], []
    for row in reader:
